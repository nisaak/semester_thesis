...
img = cv2.resize(img, (420,289), interpolation =cv2.INTER_AREA)
#cv2.imshow('img', img)
#    cv2.waitKey()
...
imgandmask = cv2.addWeighted(imgandmask,0.5,mask_v_disp,0.5,1)
"""
...
#matplotlib.image.imsave('img',img)
